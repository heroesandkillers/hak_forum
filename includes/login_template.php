...
<link rel='stylesheet' href='styles/prosilver/login_template/css/login.css'>
...
class template {
    ...
    function set_template() {
        ...
        if (file_exists($phpbb_root_path . 'styles/' . $user->theme['template_path'] . '/login_template')) {
            $this->root = $phpbb_root_path . 'styles/' . $user->theme['template_path'] . '/login_template';
            ...
            if ($user->theme['template_inherits_id']) {
                $this->inherit_root = $phpbb_root_path . 'styles/' . $user->theme['template_inherit_path'] . '/login_template';
            }
        } else {
            trigger_error('Template path could not be found: styles/' . $user->theme['template_path'] . '/login_template', E_USER_ERROR);
        }
